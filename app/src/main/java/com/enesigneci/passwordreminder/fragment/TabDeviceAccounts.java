...
public class TabDeviceAccounts extends Fragment implements DataRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((MainActivity)getActivity()).setDeviceRefreshListener(this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        passwordsList.addAll(db.passwordsDao().getByCategory("DevicePassword"));
        rvDeviceAccountPasswords.setLayoutManager(layoutManager);
        if (db.passwordsDao().getByCategory("DevicePassword").isEmpty()){
            ...
            public void onItemLongClick(View v, final int position) {
                ...
                deleteButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        deletePasswordDialog.dismiss();
                        passwordAdapter.setPasswordsList(db.passwordsDao().getByCategory("DevicePassword"));
                        if (db.passwordsDao().getByCategory("DevicePassword").isEmpty()){
                            listFilled.setVisibility(View.GONE);
                            emptyView.setVisibility(View.VISIBLE);
                        }
        ...
        rvDeviceAccountPasswords.setHasFixedSize(true);

        rvDeviceAccountPasswords.setAdapter(passwordAdapter);

        rvDeviceAccountPasswords.setItemAnimator(new DefaultItemAnimator());
        // Inflate the layout for this fragment
        return view;
    }
